...
ALLOWED_HOSTS = [os.environ.get("C9_HOSTNAME"), 'localhost', 'new-lazycamp.herokuapp.com']
...
# DEFAULT_FROM_EMAIL = 'lastminutecamp@aol.com'
...
if 'DEVELOPMENT' in os.environ:
    ...
    EMAIL_HOST_USER = os.environ.get('lastminutecamp@gmail.com')
    EMAIL_HOST_PASSWORD = os.environ.get('EMAIL_HOST_PASS')
    DEFAULT_FROM_EMAIL = os.environ.get('lastminutecamp@gmail.com')
